...
#         'NAME': 'db_antrosapp',
#         'USER': 'user_antros',
#         'PASSWORD': 'iKxRihNChVsvqUnG2wNX',
#         'HOST': 'db-datalori-prod.cu4mrovcngvy.us-east-2.rds.amazonaws.com',    # Puedes cambiarlo si tu base de datos está en un servidor remoto
